...
class NPCManager {
	...
	public void FollowPlayerCB(int NPCID, int playerID) {
		...
		int EnemyX = Server.PlayerManager.players[playerID].absX;
		int EnemyY = Server.PlayerManager.players[playerID].absY;
		npcs[NPCID].RandomWalk = false;
			...
			if (npcs[i] != null) {
				...
				if (npcs[i].walkingType == 0) {
					...
					case 2244: // banker
						...
						**/
						if(npcs[i].absX == 2665 && npcs[i].absY == 4722) { 
							/** 
							* this turns the npc 
						...
						if(npcs[i].absX == 2637 && npcs[i].absY == 4675) { 
							npcs[i].turnNpc(npcs[i].absX+1, npcs[i].absY); 
						}
						break;
				...
				if (!npcs[i].IsDead) {
					...
					for (Player p : Server.PlayerManager.players) {
						...
						if (p != null && person != null) {
							if (p != null && person != null) { 
								if (person.distanceToPoint(npcs[i].absX, npcs[i].absY) >= 5 && person.playerLevel[3] >= 1) {
							...
							if (p != null && person != null) { 
								if (person.distanceToPoint(npcs[i].absX, npcs[i].absY) <= 20 && p.heightLevel == npcs[i].heightLevel && person.playerLevel[3] >= 1) {
									if (npcs[i].npcType == 1158 || npcs[i].npcType == 1160 || npcs[i].npcType == 2597 || npcs[i].npcType == 2740 || npcs[i].npcType == 2591 || npcs[i].npcType == 2598 || npcs[i].npcType == 2610 || npcs[i].npcType == 2627 || npcs[i].npcType == 2631 || npcs[i].npcType == 2605 || npcs[i].npcType == 1913 || npcs[i].npcType == 1914 || npcs[i].npcType == 1974 || npcs[i].npcType == 1977 || npcs[i].npcType == 2605 || npcs[i].npcType == 2631 || npcs[i].npcType == 2632 || npcs[i].npcType == 3592 || npcs[i].npcType == 2627 || npcs[i].npcType == 2628 || npcs[i].npcType == 2734 || npcs[i].npcType == 2735 || npcs[i].npcType == 2629
										...
										npcs[i].IsUnderAttack = true;
										int[] NonFollow = { 2739, 2740, 2743, 2744, 2745, 2881, 2882, 2456 };
	...
	//Method is unused, find the one that's used in NPC.java - Auruo.
	/*public int GetNpcKiller(int NPCID) {
		int oldDamage = 0;
		int count = 0;
		int killerId = 0;
		for (int p = 1; p < Server.PlayerManager.maxPlayers; p++)  {	
			if (Server.PlayerManager.players[p] != null) {
				if(npcs[NPCID].Killing[p] == npcs[NPCID].Killing[killerId]) {
					if(Server.PlayerManager.players[p].totalDamageDealt > oldDamage) {
						oldDamage = Server.PlayerManager.players[p].totalDamageDealt;
						killerId = p;
					}
					Server.PlayerManager.players[p].totalDamageDealt = 0;
				}	
			}
		}
		return killerId;
			...
			if (npcs[NPCID].actionTimer == 0) {
				if (plr.playerLevel[3] <= 0) {
					...
					case 3290:
						...
						plr.frame174(153, 050, 025);
						break;

					case 87:
						npcs[NPCID].animNumber = 0x08A;
						plr.frame174(017, 050, 025);
						break;
					...
					case 1265:
						...
						hitDiff = Misc.random(3);
						plr.frame174(126, 050, 025);
						break;

					case 86:
						npcs[NPCID].animNumber = 138;
						hitDiff = Misc.random(3);
						plr.frame174(8, 050, 025);
						break;
