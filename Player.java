...
abstract class Player {
	...
	public void saveTrade(String data) {
		...
		try {
			bw = new BufferedWriter(new FileWriter("../../Files/Players/Trades/" + playerName + ".txt", true));
			bw.write(data);
			bw.newLine();
			bw.flush();
	...
	public void appendConnected() {
		BufferedWriter bw = null;
		try {
			bw = new BufferedWriter(new FileWriter("../../Files/Players/Connections/" + playerName + ".txt", true));
	...
	public void writeLog(String data, String file) {
		...
		try {
			bw = new BufferedWriter(new FileWriter("../../Files/Data/" + file + ".txt", true));
			bw.write(data);
			bw.newLine();
			bw.flush();
		} catch (IOException ioe) {
	...
	public int teleportToX = 3222, teleportToY = 3218;
	...
	protected void appendPlayerAppearance(Stream str)
	{
		...
		if (ran > attstr) {
			...
			combatLevel = (int)(((double)(getLevelForXP(playerXP[18])) * 0.125) + ((double)(getLevelForXP(playerXP[1])) * 0.25) + ((double)(getLevelForXP(playerXP[3])) * 0.25) + ((double)(getLevelForXP(playerXP[5])) * 0.125) + ((double)(getLevelForXP(playerXP[0])) * 0.325) + ((double)(getLevelForXP(playerXP[2])) * 0.325));
		}
	...
	public int AttackAnim() {
		...
		if(playerEquipment[playerWeapon] == 1349 
				|| playerEquipment[playerWeapon] == 1351 
				...
				|| playerEquipment[playerWeapon] == 1373 
				|| playerEquipment[playerWeapon] == 1377 
				|| playerEquipment[playerWeapon] == 1434 
				|| playerEquipment[playerWeapon] == 5018) {
			return 1833;
		}
		if (playerEquipment[playerWeapon] == 9101) {
			return 1833;
		}
		if (playerEquipment[playerWeapon] == 9105 || playerEquipment[playerWeapon] == 9110) {
			return 451;
		}
		if (playerEquipment[playerWeapon] == 9106) {
			return 440;
		}
		if (playerEquipment[playerWeapon] == 9109 || playerEquipment[playerWeapon] == 9100) {
			return 406;
		}
		...
		if(playerEquipment[playerWeapon] == 1291 
				...
				|| playerEquipment[playerWeapon] == 1420 
				|| playerEquipment[playerWeapon] == 2769 
				|| playerEquipment[playerWeapon] == 1422 
				|| playerEquipment[playerWeapon] == 1424 
				|| playerEquipment[playerWeapon] == 1426 
				|| playerEquipment[playerWeapon] == 1428 
				|| playerEquipment[playerWeapon] == 1430 
				|| playerEquipment[playerWeapon] == 1432 
				|| playerEquipment[playerWeapon] == 1305 
				|| playerEquipment[playerWeapon] == 6739 
				|| playerEquipment[playerWeapon] == 4587 
				|| playerEquipment[playerWeapon] == 746 
				|| playerEquipment[playerWeapon] == 5018 
				|| playerEquipment[playerWeapon] == 3101) {
			return 451;
		}

		if(playerEquipment[playerWeapon] == 3190 
				|| playerEquipment[playerWeapon] == 3192 
				|| playerEquipment[playerWeapon] == 3194 
				|| playerEquipment[playerWeapon] == 3196 
				|| playerEquipment[playerWeapon] == 3198 
				|| playerEquipment[playerWeapon] == 3200 
				|| playerEquipment[playerWeapon] == 3202 
				|| playerEquipment[playerWeapon] == 3190 
				|| playerEquipment[playerWeapon] == 2402 
	...
	boolean isInMultiWild() {
		if((absX >= 2945 && absX <= 3374 && absY >= 3759 && absY <= 3903) || (absX >= 2250 && absX <= 2280 && absY >= 4670 && absY <= 4720)) {
			return true;
		}
		return false;
	}
	...
	public int donoronly[] = { 9100, 9101, 9103, 9104, 9105, 9106, 9107, 9108, 9109, 9110, 9115, 9200, 9201, 9202, 9203, 9204, 9205 };
	public int hasSpecial[] = { 861, 1377, 1434, 2745, 2746, 2747, 2748, 3204, 4151, 4153, 4587, 5698, 7158, 7603 };
	...
	public String KilledPlayer = null;
	...
	public boolean AllStats = true;
	public boolean NpcStats = false;
	public boolean PkStats = false;
	public static int NpcKills;
	public int getTotalLvl, getTotalXP;
	public boolean keep2773, keep7601, keep7602, keep9100, keep9101, keep9102, keep9103, keep9104, keep9105, keep9106, keep9107, keep9108, keep9109, keep9110, keep9115, keep9200, keep9201, keep9202, keep9203, keep9204, keep9205;
	public int XremoveSlot, XinterfaceID, XremoveID;
	public int Bank;
	public int Shop;
	public boolean secondTradeWindow;
	public boolean InWilderness, Ahrim, Dharok, Torag, Karil, Guthan, Verac, Barrows, Summoned, makeOver;
	...
	public boolean noPrayer, drainPray, defLow, strLow, atkLow, defMid, strMid, atkMid, defHigh, strHigh, atkHigh, rapidRest, rapidHeal, protItem, protMage, protRange, protMelee, ret, redempt, smite, chiv, piety;
	...
	public boolean Questing, Stuck, UpdateHP;
	...
	public int WorldChat, clickCount, PkKills, AtkPray, DefPray, Death, FishId, Entangled, Fighting, mageGfx, mageHit, hptype;
	...
	public int RegenHp = 50;
	public int pkRating = 0;
	public int deaths = 0;
	public int pkDeaths = 0;
	public int pkPoints = 0;
	public boolean interUp;
	public int waitTimer;
	public int genieSelect = 0;
	public int SplitChat = 0;
	public int BrightnessLevel = 2;
	...
	public static int qpoints; // players quest points
	public static int qQpReward[] = {1,1,1}; // quest point reward
	public int qTimer;

	public boolean specShow;
	public boolean skipFirst = true;
	protected long lastSpoke, sendTime;
	public int objectClickCount;
	public long appendDelay, magicDelay, plantDelay, InterDelay, CmdDelay, Cmd2Delay, VengeanceDelay, FoodDelay, CombatDelay, EntangleDelay, PoisonDelay, SpecialDelay, StatDelay, SaveDelay, InterfaceDelay, JadDelay, RangeDelay, MageDelay, ActionDelay, PkingDelay, DeathDelay, TeleportDelay, ButtonDelay, TeleDelay;
	public int plantID = -1;
	public int pickPlant;
	public boolean wasRunning;
	public int agilityTimer;
}